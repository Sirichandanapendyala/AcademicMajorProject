...
from placement_app.views import HomeView, predict, results, evaluation
...
urlpatterns = [
    ...
    path('evaluation/', evaluation, name='evaluation'),  # Endpoint for showing the evaluation outcomes
]
